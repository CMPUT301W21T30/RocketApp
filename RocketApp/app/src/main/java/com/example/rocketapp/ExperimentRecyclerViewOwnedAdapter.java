...
public class ExperimentRecyclerViewOwnedAdapter extends RecyclerView.Adapter<ExperimentRecyclerViewOwnedAdapter.ViewHolder> {
    ...
    public ExperimentRecyclerViewOwnedAdapter(Context context, ArrayList<Experiment> experiments) {
